...
$java_programa = "java -jar htdocs/2Erronka_5T_Programa/Erronka_5T_programa.jar";
$pdf_karpeta = "htdocs/2Erronka_5T_Programa/faktura/";
...
if ($return_var !== 0) {
    echo "<pre>Komandoa: $komandoa</pre>";
    echo "<pre>Irteera: "; print_r($irteera); echo "</pre>";
